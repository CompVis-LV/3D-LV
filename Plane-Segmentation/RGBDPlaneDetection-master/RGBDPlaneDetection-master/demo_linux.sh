...
RGBD="/mnt/c/Users/Jared/Documents/ECTE458/3d-lv/plane-segmentation/rgbdplanedetection-master/rgbdplanedetection-master/input/"
...
OUTPUT="/mnt/c/Users/Jared/Documents/ECTE458/3d-lv/plane-segmentation/rgbdplanedetection-master/rgbdplanedetection-master/output/"
if [ ! -d "$OUTPUT" ]; then
  mkdir $OUTPUT
fi
...
do
  ...
  cecho g ${RGBD}frame-$i.depth.raw
  cecho g ${RGBD}frame-$i.color.jpg
  # $code ${RGBD}frame-$i-color.png ${RGBD}frame-$i-depth.png $OUTPUT
  $code -o ${RGBD}frame-$i.color.jpg ${RGBD}frame-$i.depth.raw $OUTPUT
